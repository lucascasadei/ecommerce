...
<body>
                                    ...
                                    <div class="offcanvas-body p-lg-0">
                                                        ...
                                                        <div id="categoryFlushOne" class="accordion-collapse collapse"
                                                            ...
                                                            <div>
                                                                ...
                                                                <ul class="nav flex-column ms-8">
                                                                    ...
                                                                    <li class="nav-item">
                                                                        <a href="javascript:void(0)"
                                                                            class="nav-link">Milk Drinks</a>
                                                                    </li>
                                                                    <!-- nav item -->
                                                                    <li class="nav-item">
                                                                        <a href="javascript:void(0)"
                                                                            class="nav-link">Curd & Yogurt</a>
                                                                    </li>
                                                                    <!-- nav item -->
                                                                    <li class="nav-item">
                                                                        <a href="javascript:void(0)"
                                                        ...
                                                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                                            ...
                                                            <div>
                                                                <ul class="nav flex-column ms-8">
                                                                    ...
                                                                    <li class="nav-item">
                                                                        <a href="javascript:void(0)"
                                                                            class="nav-link">Bhujia & Mixtures</a>
                                                                    </li>
                                                                    <!-- nav item -->
                                                                    <li class="nav-item">
                                                                        <a href="javascript:void(0)"
                                                                            class="nav-link">Namkeen Snacks</a>
                                                                    </li>
                                                                    <!-- nav item -->
                                                                    <li class="nav-item">
                                                                        <a href="javascript:void(0)"
                                                                ...
                                                                <ul class="nav flex-column ms-8">
                                                                    ...
                                                                    <li class="nav-item">
                                                                        <a class="nav-link active" aria-current="page"
                                                                            href="javascript:void(0)">Fresh
                                                                            Vegetables</a>
                                                                    </li>
                                                                    <!-- nav item -->
                                                                    <li class="nav-item">
                                                                        <a class="nav-link"
                                                                            href="javascript:void(0)">Herbs &
                                                                            Seasonings</a>
                                                                    </li>
                                                                    <!-- nav item -->
                                                                    <li class="nav-item">
                                                        ...
                                                        <div id="flush-collapseFour" class="accordion-collapse collapse"
                                                            ...
                                                            <div>
                                                                <ul class="nav flex-column ms-8">
                                                                    ...
                                                                    <li class="nav-item">
                                                                        <a href="javascript:void(0)"
                                                                            class="nav-link">Soft Drinks</a>
                                                                    </li>
                                                                    <!-- nav item -->
                                                                    <li class="nav-item">
                                                                        <a href="javascript:void(0)"
                                                                            class="nav-link">Fruit Juices</a>
                                                                    </li>
                                                                    <!-- nav item -->
                                                                    <li class="nav-item">
                                                                        <a href="javascript:void(0)"
                                                        ...
                                                        <div id="flush-collapseSix" class="accordion-collapse collapse"
                                                            ...
                                                            <div>
                                                                <ul class="nav flex-column ms-8">
                                                                    ...
                                                                    <li class="nav-item">
                                                                        <a class="nav-link active" aria-current="page"
                                                                            href="javascript:void(0)">Cookies</a>
                                                                    </li>
                                                                    <!-- nav item -->
                                                                    <li class="nav-item">
                                                                        <a class="nav-link"
                                                                            href="javascript:void(0)">Glucose &
                                                                            Marie</a>
                                                                    </li>
                                                                    <!-- nav item -->
                                                                    <li class="nav-item">
                                                                        <a class="nav-link"
                                                                            href="javascript:void(0)">Sweet & Salty</a>
                                                                    </li>
                                                                    <!-- nav item -->
                                                                    <li class="nav-item">
                                                                        <a class="nav-link"
                                                                            href="javascript:void(0)">Healthy &
                                                                            Digestive</a>
                                                                    </li>
                                                                    <!-- nav item -->
                                                                    <li class="nav-item">
                                                                        <a class="nav-link"
                                                                            href="javascript:void(0)">Cream Biscuits</a>
                                                                    </li>
                                                                    <!-- nav item -->
                                                                    <li class="nav-item">
                                                                        <a class="nav-link"
                                                                            href="javascript:void(0)">Rusks & Wafers</a>
                                                                    </li>
                                                                    <!-- nav item -->
                                                                    <li class="nav-item">
                                                                        <a class="nav-link"
                                                                            href="javascript:void(0)">Cakes & Rolls</a>
                                                                    </li>
                                                                    <!-- nav item -->
                                                                    <li class="nav-item">
                                                                        <a class="nav-link"
                                        ...
                                        <div class="card mb-6">
                                            ...
                                            <div class="card-body d-flex align-items-center border-top">
                                                <div>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                        fill="var(--fc-primary)" class="bi bi-reply"
                                                        viewBox="0 0 16 16">
                                                        <path
                                                ...
                                                <div class="ms-3">
                                                    <p class="mb-0 small">
                                                        Return Policy customers can return a product and
                                                        ask for a refund.
                                                    </p>
                                                </div>
                                            </div>
                ...
                <div class="card-body text-center py-8">
                    ...
                    <a href="ver_articulo.php?id=<?= $oferta['id']; ?>">
                        <img src="../../<?= !empty($oferta['ruta_imagen']) ? $oferta['ruta_imagen'] : 'assets/imagenes/articulos/default.png'; ?>"
                            alt="<?= htmlspecialchars($oferta['descripcion']); ?>" class="mb-3 img-fluid" style="height: 200px; object-fit: cover;">
                    </a>
                </div>
            </div>
            <div>
                ...
                <div>
                    <span class="text-dark fs-5 fw-bold">$<?= number_format($oferta['precio'], 2, ',', '.'); ?></span>
                </div>
            </div>
        </div>
    <?php endforeach; ?>
    ...
    <?php endif; ?>
                        ...
                        <div class="text-center mt-4">
                            <a href="./ver_ofertas.php" class="btn btn-primary">Ver Más Productos</a>
                        </div>
                ...
                <div class="row gy-4 align-items-center">
                    ...
                    <div class="col-lg-6 text-end mb-2 mb-lg-0">
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-inline-item">
                                <a href="#!"><img src="./../../dist/assets/images/payment/american-express.svg"
                                        alt="" /></a>
                            </li>
                            <li class="list-inline-item">
