...
<head>
    ...
    <link href="./../../dist/assets/libs/feather-webfont/./../../feather-icons.css" rel="stylesheet" />
...
<body>
        ...
        <div class="container">
            <div class="offcanvas offcanvas-start" tabindex="-1" id="navbar-default"
                ...
                <div class="offcanvas-header pb-1">
                    <a href="./index.html">
                        <img src="./../../dist/assets/images/logo/logo.png" alt="Logo eCommerce de Comestibles"
                            width="50px" />
                    </a>
                                       ...
                                       <ul class="nav nav-category" id="categoryCollapseMenu">
                                          <li class="nav-item border-bottom w-100 collapsed px-4 py-1">
                                             <a
                                                ...
                                                <span class="d-flex align-items-center">
                                                   ...
                                                   <span class="ms-2">Dairy, Bread & Eggs</span>
                                                </span>
                                             ...
                                             <div id="categoryFlushOne" class="accordion-collapse collapse" data-bs-parent="#categoryCollapseMenu">
                                                <div>
                                                   ...
                                                   <ul class="nav flex-column ms-8">
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Milk</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Milk Drinks</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Curd & Yogurt</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Eggs</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Bread</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Buns & Bakery</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Butter & More</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Cheese</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Paneer & Tofu</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Cream & Whitener</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Condensed Milk</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Vegan Drinks</a></li>
                                                   </ul>
                                                </div>
                                             </div>
                                          </li>
                                          ...
                                          <li class="nav-item border-bottom w-100 collapsed px-4 py-1">
                                             <a
                                                ...
                                                <span class="d-flex align-items-center">
                                                   ...
                                                   <span class="ms-2">Snacks & Munchies</span>
                                                </span>
                                                <i class="fa-solid fa-chevron-right"></i>
                                             ...
                                             <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#categoryCollapseMenu">
                                                <div>
                                                   <ul class="nav flex-column ms-8">
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Chips & Crisps</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Nachos</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Popcorn</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Bhujia & Mixtures</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Namkeen Snacks</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Healthy Snacks</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Cakes & Rolls</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Energy Bars</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Papad & Fryums</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Rusks & Wafers</a></li>
                                                   </ul>
                                                </div>
                                             </div>
                                          </li>
                                          <li class="nav-item border-bottom w-100 collapsed px-4 py-1">
                                             <a
                                                ...
                                                <span class="d-flex align-items-center">
                                                   ...
                                                   <span class="ms-2">Fruits & Vegetables</span>
                                                </span>
                                                <i class="fa-solid fa-chevron-right"></i>
                                             ...
                                             <div id="flush-collapseThree" class="accordion-collapse collapse" data-bs-parent="#categoryCollapseMenu">
                                                <div>
                                                   <ul class="nav flex-column ms-8">
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link active" aria-current="page" href="javascript:void(0)">Fresh Vegetables</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Herbs & Seasonings</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Fresh Fruits</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Organic Fruits & Vegetables</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Cuts & Sprouts</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Exotic Fruits & Veggies</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Flower Bouquets, Bunches</a>
                                                      </li>
                                                   </ul>
                                                </div>
                                             </div>
                                          ...
                                          <li class="nav-item border-bottom w-100 collapsed px-4 py-1">
                                             <a
                                                ...
                                                <span class="d-flex align-items-center">
                                                   ...
                                                   <span class="ms-2">Cold Drinks & Juices</span>
                                                </span>
                                                <i class="fa-solid fa-chevron-right"></i>
                                             ...
                                             <div id="flush-collapseFour" class="accordion-collapse collapse" data-bs-parent="#categoryCollapseMenu">
                                                <div>
                                                   <ul class="nav flex-column ms-8">
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Soft Drinks</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Fruit Juices</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Coldpress</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Energy Drinks</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Water & Ice Cubes</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Soda & Mixers</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Concentrates & Syrups</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Detox & Energy Drinks</a></li>
                                                      <!-- nav item -->
                                                      <li class="nav-item"><a href="javascript:void(0)" class="nav-link">Juice Collection</a></li>
                                                   </ul>
                                                </div>
                                             </div>
                                          </li>
                                          ...
                                          <li class="nav-item border-bottom w-100 collapsed px-4 py-1">
                                             <a
                                                ...
                                                <span class="d-flex align-items-center">
                                                   <svg width="24" height="24" fill="#3d4f58" viewBox="0 0 56 56" xmlns="http://www.w3.org/2000/svg">
                                                      <path
                                             ...
                                             <div id="flush-collapseFive" class="accordion-collapse collapse" data-bs-parent="#categoryCollapseMenu">
                                                <div>
                                                   <ul class="nav flex-column ms-8">
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link active" aria-current="page" href="javascript:void(0)">Diapers, Wipes & More</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Baby Food</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Bath & Hair Care</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Oral & Nasal Care</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Baby Skin Care Online</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Cleaning Needs Online</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Feeding Accessories Online</a>
                                                      </li>
                                                   </ul>
                                                </div>
                                             </div>
                                          ...
                                          <li class="nav-item border-bottom w-100 collapsed px-4 py-1">
                                             <a
                                                ...
                                                <span class="d-flex align-items-center">
                                                   ...
                                                   <span class="ms-2">Bakery & Biscuits</span>
                                                </span>
                                                <i class="fa-solid fa-chevron-right"></i>
                                             ...
                                             <div id="flush-collapseSix" class="accordion-collapse collapse" data-bs-parent="#categoryCollapseMenu">
                                                <div>
                                                   <ul class="nav flex-column ms-8">
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link active" aria-current="page" href="javascript:void(0)">Cookies</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Glucose & Marie</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Sweet & Salty</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Healthy & Digestive</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Cream Biscuits</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Rusks & Wafers</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Cakes & Rolls</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Buns & Bakery</a>
                                                      </li>
                                                   </ul>
                                                </div>
                                             </div>
                                          ...
                                          <li class="nav-item w-100 collapsed px-4 py-1">
                                             <a
                                                ...
                                                <span class="d-flex align-items-center">
                                                   ...
                                                   <span class="ms-2">Chicken, Meat & Fish</span>
                                                </span>
                                                <i class="fa-solid fa-chevron-right"></i>
                                             ...
                                             <div id="flush-collapseSeven" class="accordion-collapse collapse" data-bs-parent="#categoryCollapseMenu">
                                                <div>
                                                   <ul class="nav flex-column ms-8">
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link active" aria-current="page" href="javascript:void(0)">Chicken</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Sausage, Salami & Ham</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Exotic Meat</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Eggs</a>
                                                      </li>
                                                      <!-- nav item -->
                                                      <li class="nav-item">
                                                         <a class="nav-link" href="javascript:void(0)">Frozen Non-Veg Snacks</a>
                                                      </li>
                                                   </ul>
                                                </div>
                                             </div>
                                ...
                                <div class="item">
                                    ...
                                    <div class="card card-product mb-4">
                                        <div class="card-body text-center py-8">
                                            <!-- img -->
                                            <a href="ver_articulo.php?id=<?= $oferta['id']; ?>">
                                                <img src="../../<?= !empty($oferta['ruta_imagen']) ? $oferta['ruta_imagen'] : 'assets/imagenes/articulos/default.png'; ?>"
                                                    alt="<?= htmlspecialchars($oferta['descripcion']); ?>"
                                    ...
                                    <div>
                                        <h2 class="mt-3 fs-6">
                                            <a href="ver_articulo.php?id=<?= $oferta['id']; ?>" class="text-inherit">
                                                <?= htmlspecialchars($oferta['descripcion']); ?>
                                            </a>
                                        </h2>
                                        <div>
                                            <span
                                                class="text-dark fs-5 fw-bold">$<?= number_format($oferta['precio'], 2, ',', '.'); ?></span>
                                        </div>
                                    </div>
                                </div>
                                <?php endforeach; ?>
                        ...
                        <div class="col-12">
                            ...
                            <div
                                ...
                                <div class="d-lg-flex align-items-center">
                                    ...
                                    <div class="ms-lg-4">
                                        <h1 class="fs-2 mb-1">¿Ya viste nuestras ofertas?</h1>
                                        <span>
                                            No te pierdas los
                                            <span class="text-primary">descuentos</span>
                                            más exclusivos que tenemos para vos.
                                ...
                                <div class="mt-3 mt-lg-0">
                                    <!-- btn -->
                                    <a href="./ver_ofertas.php" class="btn btn-primary">Ver Más Ofertas</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                <div class="modal-body p-8">
                    ...
                    ">
                      ...
                      ">
                                        <!-- img -->
                                        <img src="./../../dist/assets/images/products/product-single-img-2.jpg"
                                            alt="" />
                                    </div>
                                </div>
                                <div>
                      ...
                      ">
                                        <!-- img -->
                                        <img src="./../../dist/assets/images/products/product-single-img-3.jpg"
                                            alt="" />
                                    </div>
                                </div>
                                <div>
                      ...
                      ">
                                        <!-- img -->
                                        <img src="./../../dist/assets/images/products/product-single-img-4.jpg"
                                            alt="" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="thumbnails row g-3" id="productModalThumbnails">
                                    <div class="col-3" class="tns-nav-active">
                                        <div class="thumbnails-img">
                                            <!-- img -->
                                            <img src="./../../dist/assets/images/products/product-single-img-1.jpg"
                                                alt="" />
                                        </div>
                                    </div>
                                    <div class="col-3">
    ...
    <!-- Footer -->
    <!-- footer -->
    <footer class="footer bg-dark pb-6 pt-4 pt-md-12 text-light">
        <div class="container">
            <!-- Logo y redes sociales -->
            <div class="row align-items-center mb-4">
                <div class="col-8 col-md-12 col-lg-4">
                    <a href="#"><img src="./../../dist/assets/images/logo/logo.png" alt="Distribuidora Wolchuk"
                            width="150" class="img-fluid mb-2" /></a>
                </div>
                <div class="col-4 col-md-12 col-lg-8 text-end">
                    <h6 class="mb-3 text-white">Síguenos en nuestras redes</h6>
                    <ul class="list-inline text-md-end mb-0">
                        <li class="list-inline-item me-3">
                            <a href="https://www.facebook.com/wolchukdistribuidora" target="_blank"
                                class="text-white fs-4">
                                <i class="bi bi-facebook"></i>
                            </a>
                        </li>
                        <li class="list-inline-item">
                            <a href="https://www.instagram.com/wolchukdistribuidora" target="_blank"
                                class="text-white fs-4">
            ...
            <div class="row g-4">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <h6 class="mb-4 text-white">Sobre Nosotros</h6>
                    <p class="text-muted small">
                        Somos Distribuidora Wolchuk, líderes en distribución de alimentos y productos de consumo en
                        Formosa, Argentina. Comprometidos con la calidad y el mejor servicio para nuestros clientes.
                    </p>
                    <a href="contacto.html" class="btn btn-outline-light btn-sm">Contáctanos</a>
                </div>

                <!-- Sucursales -->
                <div class="col-12 col-md-6 col-lg-3">
                    <h6 class="mb-4 text-white">Nuestras Sucursales</h6>
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2 text-muted small">📍 Fotheringham 1939, Formosa - Tel: 3704536340</li>
                        <li class="nav-item mb-2 text-muted small">📍 Av. Néstor Kirchner 4920 - Tel: 3704877498</li>
                        <li class="nav-item mb-2 text-muted small">📍 Av. Gendarmería Nacional 1284 - Tel: 3704886490
                        </li>
                    </ul>
                </div>
                ...
                <!-- Contacto -->
                <div class="col-12 col-md-6 col-lg-3">
                    <h6 class="mb-4 text-white">Atención al Cliente</h6>
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2 text-muted small">📞 Teléfono: 3704-XXXXX</li>
                        <li class="nav-item mb-2 text-muted small">✉ Email: info@wolchukdistribuidora.com</li>
                        <li class="nav-item mb-2 text-muted small">🕒 Horario: Lunes a Sábado, 8:00 - 18:00 hs</li>
                    </ul>
                </div>

                <!-- Métodos de Pago -->
                <div class="col-12 col-md-6 col-lg-3">
                    <h6 class="mb-4 text-white">Métodos de Pago</h6>
                    <ul class="list-inline">
                        <li class="list-inline-item">
                            <img src="./../../dist/assets/images/payment/visa.svg" width="50" alt="Visa" />
                        </li>
                        <li class="list-inline-item">
                            <img src="./../../dist/assets/images/payment/mastercard.svg" width="50" alt="Mastercard" />
                        </li>
                        <li class="list-inline-item">
                            <img src="./../../dist/assets/images/payment/paypal.svg" width="50" alt="PayPal" />
                        </li>
                        <li class="list-inline-item">
                            <img src="./../../dist/assets/images/payment/mercadopago.svg" width="50"
                                alt="Mercado Pago" />
                        </li>
                    </ul>
                </div>
            ...
            <div class="text-center small text-muted">
                © <span id="copyright"></span> Distribuidora Wolchuk. Todos los derechos reservados.
            </div>
        </div>
    </footer>
