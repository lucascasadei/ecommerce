...
<html lang="en">
  ...
  <body>
    ...
    <header>
      <div class="container">
        <div class="row align-items-center pt-2">
          ...
          <div
            class="col-xl-9 col-lg-4 col-5 d-md-flex align-items-center justify-content-end"
          >
            <a href="#" class="text-reset">Soporte</a>
            <a href="#" class="mx-md-8 ms-4 text-reset">Envíos</a>
            <a href="#" class="text-reset d-none d-md-block">Garantía</a>
          </div>
        </div>
              ...
              <div class="text-center">
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-lg p-0">
                    <div>
                      <h6 class="px-4 border-bottom py-3 mb-0">
                        Notificaciones
                      </h6>
                      <p class="mb-0 px-4 py-3">
                        ...
                        o
                        <a href="#">regístrate</a>
                        para no tener que ingresar tus datos cada vez
                      </p>
                    </div>
                  </div>
                </div>
    ...
    <nav
      class="navbar navbar-expand-lg navbar-light navbar-default p-0 p-sm-0 navbar-offcanvas-color"
    ...
    <div
      class="bg-white position-fixed bottom-0 w-100 z-1 shadow-lg d-block d-lg-none text-center"
    >
      ...
      <section class="mt-8">
        <div class="container">
          <div class="hero-slider">
            ...
            >
              <div
                class="ps-lg-12 py-lg-16 col-xxl-5 col-lg-7 col-md-8 py-14 px-8 text-xs-center"
              >
                    ...
                    <div class="offcanvas-body p-lg-0">
                      <div class="mb-4">
                        ...
                        <div class="card">
                          ...
                          >
                            <li
                              class="nav-item border-bottom w-100 collapsed px-4 py-1"
                            >
                              <a
                                href="javascript:void(0)"
                                class="nav-link"
                      ...
                      <div class="card mb-6">
                        ...
                        <div
                          class="card-body d-flex align-items-center border-top"
                        >
                          <div>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="d-flex">
                  <div class="mt-1">
                    <svg
                      ...
                      height="24"
                      fill="currentColor"
                      class="bi bi-journal text-primary"
                      viewBox="0 0 16 16"
                    >
                      <path
                ...
                <div>
                  <h4 class="h5">
                    <a href="javascript:void(0)" class="text-inherit"
                      >Spaghetti with Crispy Zucchini</a
                    >
                  </h4>
                  <p>
